  ...
  function(_, BookstrapPage, BookstrapPageCollection, BookstrapDOMPage) {
    ...
    ReplicasPlugin.prototype = {
      setOrientation: function() {
        bookstrap.orientation = bookstrap.viewport.width > bookstrap.viewport.height ? 'landscape' : 'portrait';
      ...
      onNavLoaded: function() {
        ...
        bookstrap.pages.getNext = function(index) {
          ...
          if (bookstrap.orientation == 'landscape' && p.spreadIndex && p.spreadIndex %2 == 1 && nextIndex.spreadIndex)
